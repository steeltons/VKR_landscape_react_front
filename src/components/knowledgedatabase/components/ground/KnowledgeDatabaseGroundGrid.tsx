...
import CreateSoilForm from "./CreateGroundForm";
import { deleteGround, getAllGrounds, GroundRsDto } from "../../../../services/ground";
...
function convertToKnowledfeDatabaseObjectUi(response : GroundRsDto) : KnowledgeDatabaseObjectUi {
    return {
        id: response.ground_id,
        name: response.ground_name,
        description: response.ground_description,
        base64Image: response.ground_picture_base64
    }
}
...
const KnowledgeDatabaseGroundGrid = () => {
...
export default KnowledgeDatabaseGroundGrid;