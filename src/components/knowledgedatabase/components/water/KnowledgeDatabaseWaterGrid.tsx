...
import { deleteWater, getAllWaters, WaterRsDto } from "../../../../services/water";
import CreateWaterForm from "./CreateWaterForm";
...
function convertToKnowledfeDatabaseObjectUi(response : WaterRsDto) : KnowledgeDatabaseObjectUi {
    return {
        id: response.water_id,
        name: response.water_name,
        description: response.water_description,
        base64Image: response.water_picture_base64
    }
}
...
const KnowledgeDatabaseWaterGrid = () => {
...
export default KnowledgeDatabaseWaterGrid;