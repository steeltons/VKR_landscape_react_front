...
import CreateWaterForm from "./CreateLandscapeForm";
import { deleteLandscape, getAllLandscapes, LandscapeRsDto } from "../../../../services/landscape";
...
function convertToKnowledfeDatabaseObjectUi(response : LandscapeRsDto) : KnowledgeDatabaseObjectUi {
    return {
        id: response.landscape_id,
        name: response.landscape_name,
        description: response.landscape_description,
        base64Image: response.landscape_picture_base64
    }
}
...
const KnowledgeDatabaseLandscapeGrid = () => {
    ...
    useEffect(() => {
        const formData = async () => {
            try {
                const response = await getAllLandscapes(true);
...
export default KnowledgeDatabaseLandscapeGrid;